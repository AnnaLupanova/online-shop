  ...
  <div class="main">
    ...
    <div class="v-catalog-running">
      ...
      <div class="filters">
        ...
        <div class="v-catalog-running__list">
          <v-catalog-item
...
export default {
  ...
  methods: {
    ...
    sortByCategaries(category) {
      let vm = this;
      this.sortedProducts = [...this.PRODUCTS_RUNNING];
  ...
  mounted() {
    this.GET_PRODUCTS_FROM_API_RUNNING()
        .then((responce) => {
          if (responce.data) {
            this.sortByCategaries()
          }
