<template>
  <div class="main">
    ...
    <div class="v-catalog-fitness">
      ...
      <div class="v-catalog-fitness__list">
        <v-catalog-item
...
export default {
  ...
  methods: {
    ...
    sortByCategaries(category) {
      let vm = this;
      this.sortedProducts = [...this.PRODUCTS_FITNESS];
  ...
  mounted() {
    this.GET_PRODUCTS_FROM_API_FITNESS()
        .then((responce) => {
          if (responce.data) {
            this.sortByCategaries()
          }
